package com.ptshell.calendar.activity;
...
import com.ptshell.calendar.R;
import com.ptshell.calendar.view.BorderTextView;
import com.ptshell.calendar.calendar.LunarCalendar;
import com.ptshell.calendar.constant.CalendarConstant;
import com.ptshell.calendar.utils.ScheduleDAO;
import com.ptshell.calendar.bean.ScheduleDateBean;
import com.ptshell.calendar.bean.ScheduleBean;
...
public class ScheduleActivity extends Activity {
    ...
    private ArrayList<ScheduleDateBean> dateTagList = new ArrayList<ScheduleDateBean>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scheduleType.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(ScheduleActivity.this, ScheduleTypeActivity.class);
        ...
        scheduleSave.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(scheduleText.getText().toString())) {
                    //判断输入框是否为空
                    new AlertDialog.Builder(ScheduleActivity.this).setTitle("输入日程").setMessage("日程信息不能为空").setPositiveButton("确认", null).show();
                } else {
                    //将日程信息保存
                    ...
                    ScheduleBean schedulevo = new ScheduleBean();
                    ...
                    Intent intent = new Intent();
                    intent.setClass(ScheduleActivity.this, ScheduleInfoActivity.class);
    ...
    public void setScheduleDateTag(int remindID, String year, String month, String day, int scheduleID) {
        ...
        if (remindID >= 0 && remindID <= 3) {
            ...
            ScheduleDateBean dateTag = new ScheduleDateBean();
