...
import com.ptshell.calendar.view.BorderEditText;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case Menu.FIRST:
                ...
                intent.setClass(ScheduleInfoActivity.this, AllScheduleActivity.class);
            ...
            public boolean onLongClick(View v) {
                ...
                new AlertDialog.Builder(ScheduleInfoActivity.this).setTitle("删除日程").setMessage("确认删除").setPositiveButton("确认", new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        intent1.setClass(ScheduleInfoActivity.this, AllScheduleActivity.class);
