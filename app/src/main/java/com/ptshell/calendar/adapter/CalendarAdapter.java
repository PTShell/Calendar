package com.ptshell.calendar.adapter;
...
import com.ptshell.calendar.calendar.SpecialCalendar;
...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.layout_calendar_adapter, null);
        }
    ...
    private void getweek(int year, int month) {
        ...
        ArrayList<ScheduleDateBean> dateTagList = dao.getTagDate(year, month);
            ...
            if (i < 7) {
                ...
                if (dateTagList != null && dateTagList.size() > 0) {
                    for (int m = 0; m < dateTagList.size(); m++) {
                        ScheduleDateBean dateTag = dateTagList.get(m);
